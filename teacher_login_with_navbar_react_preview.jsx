  ...
  return (
    <section className="bg-white rounded-2xl p-6 ring-1 ring-black/5 shadow-xl">
      <div className="text-center mb-4">
        <h1 className="text-2xl md:text-3xl font-extrabold mb-1" style={{ color: blue }}>התחברות למורים</h1>
      ...
      <p className="text-center text-gray-600 mt-5 font-bold">אין לך חשבון? <a href="#/signup-teacher" className="hover:underline" style={{ color: orange }}>להרשמה</a></p>
    </section>
  );
}

export default function TeacherLoginWithNavbarPreview() {
  return (
